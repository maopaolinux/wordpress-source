<div id="posts" class="small-thumbs">
  ...
  <div class="entry entry-links clearfix" <?php if( get_opt('sliding_s') ){echo 'data-animate="'.get_opt('animation_style').'"';}?>>
	  <span class="imgico"><?php if (get_opt('dms_cat_s')){?><div class="pos-tag"><?php the_category(', ') ?></div><?php }?></span>
...
<li><?php $price = get_post_meta($post->ID, 'tgzz_value', true);{echo $price; }?></li>
      ...
      <div class="entry-content-one">
        <p><?php if ( wp_is_mobile() ){echo wp_trim_words( get_the_content(), 40 );}else{echo wp_trim_words( get_the_content(), 90 );} ?></p>
		</div>
    </div>

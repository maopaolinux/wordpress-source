<?php if(is_home())://如果是首页则显示《li》的内容 ?>
<?php if (get_opt('ho2_sign_s')){//判断后台选项是否打开如果打开则显示，反之则否?>
<div class="section header-stick bottommargin-sm clearfix" style="padding: 20px 0;">
      <div>
        <div class="container clearfix" style="width: 1222px;"> <span class="label label-danger bnews-title"> <?php echo get_opt('ho2_sign_title');?></span>
        	
          <div class="bnews-slider nobottommargin">
            
              <div class="slider-wrap">
               
        	<div id="notice"><?php echo get_opt('ho2_sign_text') ?></div>
...
<?php if(is_single()): //如果是文章页则显示《li》的内容?>
		<div class="section header-stick bottommargin-sm clearfix" style="padding: 20px 0;"><div>
             <div class="container clearfix" style="width: 1222px;">

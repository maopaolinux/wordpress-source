...
//头像
echo '<div class="c-avatar"><div class="comment-author vcard"><span class="comment-avatar clearfix">
<img class="avatar" alt="avatar" src="'.preg_replace(array('/^.+(src=)(\"|\')/i', '/(\"|\')\sclass=(\"|\').+$/i'), array('', ''), get_avatar($comment, '60')).
'" /></span></div></div>';
//内容
  echo '<div class="c-main" id="div-comment-'.get_comment_ID().'">';  
	echo str_replace(' src=', ' src=', convert_smilies(get_comment_text()));
	if($comment->user_id == '1') 
		echo '<img src="'.get_bloginfo('template_directory').'/images/master.png">';
